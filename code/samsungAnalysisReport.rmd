# Human Activity Recognition on Smartphones using a Random Forest Approach
...
training_set <- droplevels(subset(samsungData, subject %in% c(1, 3, 5, 6, 7, 8, 11, 14)))
unique(training_set$subject)

validition_set <- droplevels(subset(samsungData, subject %in% c(15, 16, 17, 19, 21, 22, 23)))
unique(validition_set$subject)

test_set <- droplevels(subset(samsungData, subject %in% c(27, 28, 29, 30)))
